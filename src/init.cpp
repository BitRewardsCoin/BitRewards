...
std::string HelpMessage()
{
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 13764 or testnet: 23764)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 13763 or testnet: 23763)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if(fEnableInstantX){
        ...
        if(nInstantXDepth < 0) nAnonymizeBitRewardsAmount = 0;
    } else {
        nInstantXDepth = 0;
    }
