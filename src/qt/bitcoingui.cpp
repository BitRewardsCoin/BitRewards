...
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/bitrewards"));
    setWindowIcon(QIcon(":icons/bitrewards"));
#else
...
void BitcoinGUI::setNumI2PConnections(int count)
{
    ...
    labelI2PConnections->setToolTip(tr("%n active connection(s) to I2P-BitRewards network", "", count));
}
#endif
